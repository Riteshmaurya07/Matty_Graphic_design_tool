    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      <main className="flex-grow flex justify-center items-center px-4 py-12">
        ...
        >
          ...
          <p className="text-gray-600 leading-relaxed mb-8 text-center animate-fadeIn delay-[0.2s]">
          ...
          {/* Mission */}
          <div className="mb-8 animate-fadeIn delay-[0.4s]">
          ...
          {/* Why Choose Us */}
          <div className="animate-fadeIn delay-[0.6s]">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li
                  key={index}
                  className="flex items-start space-x-3 text-gray-700 opacity-0 animate-fadeInUp"
